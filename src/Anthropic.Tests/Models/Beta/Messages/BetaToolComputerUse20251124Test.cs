...
public class BetaToolComputerUse20251124Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("computer_20251124");
        List<ApiEnum<string, BetaToolComputerUse20251124AllowedCaller>> expectedAllowedCallers =
        [
        ...
        Assert.Equal(expectedEnableZoom, model.EnableZoom);
...
public class BetaToolComputerUse20251124AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(BetaToolComputerUse20251124AllowedCaller.Direct)]
    [InlineData(BetaToolComputerUse20251124AllowedCaller.CodeExecution20250825)]
    public void Validation_Works(BetaToolComputerUse20251124AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaToolComputerUse20251124AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(BetaToolComputerUse20251124AllowedCaller.Direct)]
    [InlineData(BetaToolComputerUse20251124AllowedCaller.CodeExecution20250825)]
    public void SerializationRoundtrip_Works(BetaToolComputerUse20251124AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaToolComputerUse20251124AllowedCaller> value = rawValue;
