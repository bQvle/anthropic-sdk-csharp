...
public class BetaToolBash20241022Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        JsonElement expectedType = JsonSerializer.SerializeToElement("bash_20241022");
...
public class BetaToolBash20241022AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(BetaToolBash20241022AllowedCaller.Direct)]
    [InlineData(BetaToolBash20241022AllowedCaller.CodeExecution20250825)]
    public void Validation_Works(BetaToolBash20241022AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaToolBash20241022AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, BetaToolBash20241022AllowedCaller>>(
    ...
    [InlineData(BetaToolBash20241022AllowedCaller.Direct)]
    [InlineData(BetaToolBash20241022AllowedCaller.CodeExecution20250825)]
    public void SerializationRoundtrip_Works(BetaToolBash20241022AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaToolBash20241022AllowedCaller> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, BetaToolBash20241022AllowedCaller>
