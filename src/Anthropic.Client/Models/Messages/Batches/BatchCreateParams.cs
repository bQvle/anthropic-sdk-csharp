...
public sealed record class Params : ModelBase, IFromRaw<Params>
{
    ...
    public ApiEnum<
        string,
        global::Anthropic.Client.Models.Messages.Batches.ServiceTier
    >? ServiceTier
    {
        get
        {
    ...
    public global::Anthropic.Client.Models.Messages.Batches.SystemModel? System
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<global::Anthropic.Client.Models.Messages.Batches.SystemModel?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
sealed class ServiceTierConverter
    : JsonConverter<global::Anthropic.Client.Models.Messages.Batches.ServiceTier>
{
    public override global::Anthropic.Client.Models.Messages.Batches.ServiceTier Read(
    ...
    )
    {
        ...
        {
            "auto" => global::Anthropic.Client.Models.Messages.Batches.ServiceTier.Auto,
            "standard_only" => global::Anthropic
                ...
                .ServiceTier
                .StandardOnly,
            _ => (global::Anthropic.Client.Models.Messages.Batches.ServiceTier)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Anthropic.Client.Models.Messages.Batches.ServiceTier value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Anthropic.Client.Models.Messages.Batches.ServiceTier.Auto => "auto",
                global::Anthropic.Client.Models.Messages.Batches.ServiceTier.StandardOnly =>
                    "standard_only",
...
public record class SystemModel
{
    ...
    public SystemModel(IReadOnlyList<TextBlockParam> value)
    {
    ...
    public static global::Anthropic.Client.Models.Messages.Batches.SystemModel CreateUnknownVariant(
        JsonElement value
    )
    {
...
sealed class SystemModelConverter
    : JsonConverter<global::Anthropic.Client.Models.Messages.Batches.SystemModel>
{
    public override global::Anthropic.Client.Models.Messages.Batches.SystemModel? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        try
        {
            ...
            {
                return new global::Anthropic.Client.Models.Messages.Batches.SystemModel(
                    deserialized
                );
            }
        }
    ...
    public override void Write(
        Utf8JsonWriter writer,
        global::Anthropic.Client.Models.Messages.Batches.SystemModel value,
        JsonSerializerOptions options
    )
    {
