...
public sealed record class BetaCitationContentBlockLocationParam : ModelBase
{
...
class BetaCitationContentBlockLocationParamFromRaw : IFromRaw<BetaCitationContentBlockLocationParam>
{
    /// <inheritdoc/>
