...
[JsonConverter(
    typeof(ModelConverter<CitationContentBlockLocation, CitationContentBlockLocationFromRaw>)
)]
public sealed record class CitationContentBlockLocation : ModelBase
{
